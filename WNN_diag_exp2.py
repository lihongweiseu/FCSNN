...
def WNN(in_s, state_s, out_s, non_layer_s, non_neuron, Para, dt, device, bias_status):
    # Define WNN
    class WNN(nn.Module):
        def __init__(self):
...
def WNN_training(dt, u, WNN_model, N, y_ref, in_s, state_s, out_s, non_layer_s, non_neuron, Para, device, bias_status):
    ...
    loss_m = loss.item()
    WNN_model_m = WNN(in_s, state_s, out_s, non_layer_s, non_neuron, Para, dt, 'cpu', bias_status)
