...
pt_match = glob.glob(os.path.join('./saved_models', 'MR_WNN_20_unstable.pt'))
...
y_pre = y_WNN_torch.detach().reshape([Nt2, 1]).numpy()
...
ax.plot(t, y_pre/1000, color='r', dashes=[2, 2], lw=0.5, label='WNN (20)')
