...
for i in range(1,21):
    ...
    FCSNN_model_m, loss_all, loss_m, cost_time, im, cost_time_str = FCSNN_training(dt, u[0:Nt1,:,:], FCSNN_model, N, y_ref[0:Nt1,:,:], in_s, state_s, out_s, non_layer_s, non_neuron, A_ini, B_ini, device, bias_status)
